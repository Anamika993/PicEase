    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
          Create imaginative and visual stunning images and share them with the
          community...
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <div
            className="relative bg-gray-50 border border-gary-300 text-gary-900 text-sm rounded-lg focus:ring-blue-500
        ...
        <div className="mt-10">
          ...
          <button className="mt-3 text-white bg-[#6464ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center">
